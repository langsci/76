...
An example of an \textsc{xml}-tagged utterance and of its translations into EL and ES, as outputted from ELAN following processing in \textsc{tei}-Drop, is in Figure 2.

\begin{figure}
\caption{Example of an \textsc{xml}-tagged utterance}
\begin{lstlisting}
<div>
<u who="\# SPK1">
<anchor synch="\# T3497"/>
