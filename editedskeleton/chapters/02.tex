...
An example of an XML-tagged utterance and of its translations into EL and ES, as outputted from ELAN following processing in TEI-Drop, is in Figure 2.

\begin{figure}
\caption{Example of an XML-tagged utterance}
\begin{lstlisting}
<div>
<u who="\# SPK1">
<anchor synch="\# T3497"/>
...
\ea Your mother, she \emph{hated them niggers} too (\textit{Monster's Ball})
\z
\ea That means \emph{not welcome} (\textit{American History X}) [utterance addressed to a Jew while the speaker reveals his swastika tattoo]
\z
\ea Take your fucking pizza piece and \emph{go the fuck back to Africa} (\textit{Do the Right Thing})
\z
\ea Yeah, \emph{fuck off, you Paki bastards} (\textit{This is England})
\z
\ea \emph{What the hell are those niggers} doing out there? (\textit{Monster's Ball})
\z

\subsubsection{Appreciation}

\ea We'll let the \emph{niggers, kikes and spics} grab for their piece of the pie (\textit{American History X})
\z
\ea A \textit{bunch of people} who \emph{aren't even citizens of this country} [{\dots}] (\textit{American History X})
\z
\ea She \emph{smells like fish and chips and guacamole} (\textit{American History X})
\z
\ea Three and a half million of us, who can't find fucking work because \emph{they're taking them all, because it's fucking cheap labour} (\textit{American History X})
\z
\ea How come \emph{niggers are so stupid}? (\textit{Do the Right Thing})
\z
\ea Magic, Eddie, Prince, are not \emph{niggers}. I mean, they're not \emph{black}, I mean... (\textit{Do the Right Thing})
\z

\subsubsection{Judgement}


\ea Look at these little \emph{fucking sewer rats} (\textit{This is England}) [referring to young immigrants playing in a yard]
\z
\ea \emph{Immigration, AIDS, welfare, those are problems of the black community, the Hispanic community, the Asian community} (\textit{American History X})
\z
\ea One in every three black males is in some phase of the correctional system. Is that a coincidence or do these people \emph{have like a racial commitment to crime}? (\textit{American History X})
\z
\ea All right. Well, you know what I can't do? I can't look at you without thinking about the \emph{five or six more qualified white men who didn't get your job} (\textit{Crash})
\z
\ea He's one of those \emph{proud to be nigger people} (\textit{American History X})
\z
...
\ea You \emph{gold-teeth, gold-chain-wearing, fried-chicken and biscuit-eating monkey, ape, baboon, big-thigh, fast running, high-jumping, spear chucking, 360-degree basketball-dunking, titsoon, spade, moulignon}!
\z
...
\ea What is it, Black History Month? (\textit{American History X})
\z
...
\ea Man's singing about lynching niggers. “Gonna buy me a rope and lynch me a nigger” (\textit{Crash})
\z
\ea Your partner's a racist prick (\textit{Crash})
\z
...
The attitude classification outlined above and used as annotation scheme in the reported project can be schematised in Figure 4.
