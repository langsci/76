...
An example of an \textsc{xml}-tagged utterance and of its translations into EL and ES, as outputted from \textsc{elan} following processing in \textsc{tei}-Drop, is in \figref{fig:2:2}.
