...
An example of an \textsc{xml}-tagged utterance and of its translations into EL and ES, as outputted from \textsc{elan} following processing in \textsc{tei}-\textsc{D}rop, is in \figref{fig:2:2}.
...
\item \textit{Judgement}: characterises negative evaluations of the behaviour \todo{I changed the word order here in order to fit the line.} of Others, judged as people that act in relation to their racial/ethnic/religious difference.
\end{itemize}
