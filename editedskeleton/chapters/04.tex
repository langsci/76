...
In the first step, we want to test if lexical density and type--token--ratio are lower in translation variant than in \textsc{eo} and \textsc{go}.
     ...
     \lsptoprule
              & \textbf{\textsc{eo}}  & \textbf{\textsc{go}} & \textbf{\textsc{pt}	\textsc{cat}} & \textbf{HU-$\bar{x}$} & \textbf{\textsc{rbmt}	\textsc{smt}1	\textsc{smt}2} & \textbf{\textsc{mt}-$\bar{x}$}  & \textbf{Trans-$\bar{x}$}\\ \midrule 
