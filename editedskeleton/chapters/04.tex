...
All subcorpora under analysis are tokenised, lemmatised and tagged with part-of-speech information, segmented into syntactic chunks and sentences.  The annotations of the \textsc{vartra}-\textsc{small} subcorpora were obtained with Tree Tagger (\todo{I inserted a `see' here to fit the line} see \citealt{Schmid1994}). The availability of these annotation levels in both corpora allows us to analyse certain lexico-grammatical patterns – operationalisation of the translation features under analysis, defined in \sectref{sec:4:2:3}.
...
\lsptoprule
\textbf{subc}    & \multicolumn{1}{c}{\textbf{nominal}}  & \multicolumn{1}{c}{\textbf{verbal}}  & \multicolumn{1}{c}{\textbf{NVratio}} \\ \midrule
