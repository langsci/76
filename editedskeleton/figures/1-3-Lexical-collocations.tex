...
\begin{tikzpicture}
\begin{axis}[ybar, symbolic x coords={N + ADJ,N + prep + N,N + V,V + N}, xtick=data, nodes near coords, nodes near coords align={vertical}, every node near coord/.append style={rotate=90, anchor=west}, axis x line*=bottom, axis y line*=left, tickwidth=0pt, ymin=0, bar width=15, width=\textwidth, height={}, x tick label style={font=\bfseries, below=.25cm, draw, fill=gray!20, opacity=0.5}]
